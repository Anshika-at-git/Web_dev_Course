...
const gifs = ["Question-Panda.gif", "Sad-panda.gif", "Crying-Panda.gif", "panda-cry.gif"];
// array of messages
const buttonMessages = ["Are you sure, cutuu??", "Really?😤", "BABYGIRLLLL🥺", "You can't do this to me :("];
